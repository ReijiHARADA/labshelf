...
export const categoryColors: Record<BookCategory | string, string> = {
  ...
  'タイポグラフィ・フォント': 'var(--spine-orange)',
  '色彩・配色': 'var(--spine-pink)',
  'ロゴ・ブランディング': 'var(--spine-yellow)',
  イラストレーション: 'var(--spine-yellow)',
  '写真・映像': 'var(--spine-teal)',
  '3DCG・ゲーム': 'var(--spine-indigo)',
  'Webデザイン・制作': 'var(--spine-blue)',
  'UI・UX': 'var(--spine-purple)',
  デザインリサーチ: 'var(--spine-purple)',
  'サービスデザイン・デザイン思考': 'var(--spine-pink)',
  '情報デザイン・可視化': 'var(--spine-blue)',
  'プロダクト・ものづくり': 'var(--spine-brown)',
  'アート・メディア表現': 'var(--spine-pink)',
  'プログラミング・開発': 'var(--spine-navy)',
  クリエイティブコーディング: 'var(--spine-green)',
  'AI・データサイエンス': 'var(--spine-green)',
  '電子工作・IoT': 'var(--spine-orange)',
  '認知科学・心理学': 'var(--spine-indigo)',
  '感性工学・感情': 'var(--spine-pink)',
  '研究法・統計': 'var(--spine-teal)',
  '論文・アカデミックライティング': 'var(--spine-brown)',
  '就活・キャリア': 'var(--spine-yellow)',
  'ビジネスマナー・仕事術': 'var(--spine-gray)',
  'マーケティング・ビジネス': 'var(--spine-orange)',
  '教養・社会・カルチャー': 'var(--spine-gray)',
